...
\begin{enumerate}
 ...
 to prior work.
 \item It may also make sense to add: 
 \begin{enumerate}
   \item suggestions for how to best build upon the thesis research in future work.
 \end{enumerate}
 \item Otherwise these suggestions should appear in the conclusion of the thesis.
\end{enumerate}
